...
# obj formatting
_OBJ=glad.o utils.o audio.o mouse.o texture.o lighting.o shader.o camera.o graphics.o world.o walkmap.o engine.o main.o
...
$(OBJ_DIR)world.o: $(SRC_DIR)world.cpp $(INCLUDE_DIR)world.h $(INCLUDE_DIR)shapes.h
$(OBJ_DIR)walkmap.o: $(SRC_DIR)walkmap.cpp $(INCLUDE_DIR)walkmap.h
